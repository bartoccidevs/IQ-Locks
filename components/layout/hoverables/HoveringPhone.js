...
export default function HoveringPhone() {
    ...
    return (
        <Link href={`tel:${siteData.phone}`} aria-label="Click to call the locksmith">
            <div className="md:hidden hovering-phone bg-theme-primary fixed bottom-4 right-4 rounded-full pointer-events-auto hover:scale-110" onClick={handlePhoneClick}>
