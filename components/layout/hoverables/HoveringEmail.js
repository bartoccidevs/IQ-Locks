...
export default function HoveringEmail() {
    ...
    return (
        <Link href={`mailto: ${siteData.email}`} aria-label="Click to open an email to the locksmith">
            <div className="hidden md:flex hovering-email bg-theme-primary fixed bottom-10 right-10 rounded-full pointer-events-auto hover:scale-110" onClick={handlePhoneClick}>
